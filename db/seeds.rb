...
user2 = User.create(username: "Mongina")
...
comment1= Comment.create(comment:"Lovely article", author:user1.id)
comment2= Comment.create(comment:"Men really need to speak up", author: user2.id)
